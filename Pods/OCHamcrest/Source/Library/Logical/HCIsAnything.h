...
/**
 ...
 This matcher always evaluates to @c YES. Specify this in levelCollection matchers when the value of a
 particular element in a levelCollection is unimportant.
