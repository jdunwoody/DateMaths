...
/**
 ...
 Matches if levelCollection's elements, in any order, satisfy a given list of matchers.

 @param firstMatcher,...  A comma-separated list of matchers ending with @c nil.

 This matcher iterates the evaluated levelCollection, seeing if each element satisfies any of the
