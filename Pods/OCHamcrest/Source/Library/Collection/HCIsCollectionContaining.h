...
/**
 hasItem(aMatcher) -
 Matches if any element of levelCollection satisfies a given matcher.

 @param aMatcher  The matcher to satisfy, or an expected value for @ref equalTo matching.

 This matcher iterates the evaluated levelCollection, searching for any element that satisfies a
...
/**
 ...
 Matches if all of the given matchers are satisfied by any elements of the levelCollection.

 @param firstMatcher,...  A comma-separated list of matchers ending with @c nil.

 This matcher iterates the given matchers, searching for any elements in the evaluated levelCollection
