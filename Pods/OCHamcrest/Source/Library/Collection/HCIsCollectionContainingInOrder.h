...
/**
 ...
 Matches if levelCollection's elements satisfy a given list of matchers, in order.

 @param firstMatcher,...  A comma-separated list of matchers ending with @c nil.

 This matcher iterates the evaluated levelCollection and a given list of matchers, seeing if each
