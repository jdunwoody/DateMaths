...
/**
 ...
 Matches if each element of levelCollection satisfies any of the given matchers.

 @param firstMatcher,...  A comma-separated list of matchers ending with @c nil.

 This matcher iterates the evaluated levelCollection, confirming whether each element satisfies any of
 the given matchers.
